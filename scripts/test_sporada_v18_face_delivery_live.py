...
def main() -> None:
    ...
    try:
        ...
        schema = json.loads((ROOT / "delivery/apexfabric-v1/intel-285h/traffic-v18/face-sample.schema.json").read_text())
        jsonschema.validate(sample, schema)
        event_schema = json.loads((ROOT / "delivery/apexfabric-v1/intel-285h/traffic-v18/analytics-event.schema.json").read_text())
